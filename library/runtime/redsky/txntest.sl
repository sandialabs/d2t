...
#SBATCH --job-name=datastore.testing
#SBATCH --nodes=2
#SBATCH --time=0:02:00

echo starting txn testing

WORK_DIR=/gscratch2/jdayal/txntests
...
#mpiexec -np 1 --npernode 1 numa_wrapper --ppn 1 ${WORK_DIR}/datastore_server &> ${SERVER_LOG_FILE} &
mpiexec -np 10 --npernode 5 ${WORK_DIR}/testclnt &> ${SERVER_LOG_FILE} &
