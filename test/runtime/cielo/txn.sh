...
case $CORES in
	8)       nx=2 ;  ny=2 ;  nz=2  ; rank_to_fail=-1
	   ;;
	16)      nx=2 ;  ny=2 ;  nz=4  ; rank_to_fail=-1
	   ;;
	32)      nx=2 ;  ny=4 ;  nz=4  ; rank_to_fail=-1
	   ;;
	64)      nx=4 ;  ny=4 ;  nz=4  ; rank_to_fail=-1
	   ;;
	128)     nx=4 ;  ny=4 ;  nz=8  ; rank_to_fail=-1
	   ;;
	256)     nx=4 ;  ny=8 ;  nz=8  ; rank_to_fail=-1
	   ;;
	512)     nx=8 ;  ny=8 ;  nz=8  ; rank_to_fail=-1
	   ;;
	1024)    nx=8 ;  ny=8 ;  nz=16 ; rank_to_fail=-1
	   ;;
	2048)    nx=8 ;  ny=16 ; nz=16 ; rank_to_fail=-1
	   ;;
	4096)    nx=16 ; ny=16 ; nz=16 ; rank_to_fail=-1
	   ;;
	8192)    nx=16 ; ny=16 ; nz=32 ; rank_to_fail=-1
	   ;;
	16384)   nx=16 ; ny=32 ; nz=32 ; rank_to_fail=-1
	   ;;
	32768)   nx=32 ; ny=32 ; nz=32 ; rank_to_fail=-1
	   ;;
	65536)   nx=32 ; ny=32 ; nz=64 ; rank_to_fail=-1
	   ;;
esac
