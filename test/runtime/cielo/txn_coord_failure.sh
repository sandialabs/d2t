...
case $CORES in
	8)       nx=2 ;  ny=2 ;  nz=2  ; rank_to_fail=0
	   ;;
	16)      nx=2 ;  ny=2 ;  nz=4  ; rank_to_fail=0
	   ;;
	32)      nx=2 ;  ny=4 ;  nz=4  ; rank_to_fail=0
	   ;;
	64)      nx=4 ;  ny=4 ;  nz=4  ; rank_to_fail=0
	   ;;
	128)     nx=4 ;  ny=4 ;  nz=8  ; rank_to_fail=0
	   ;;
	256)     nx=4 ;  ny=8 ;  nz=8  ; rank_to_fail=0
	   ;;
	512)     nx=8 ;  ny=8 ;  nz=8  ; rank_to_fail=0
	   ;;
	1024)    nx=8 ;  ny=8 ;  nz=16 ; rank_to_fail=0
	   ;;
	2048)    nx=8 ;  ny=16 ; nz=16 ; rank_to_fail=0
	   ;;
	4096)    nx=16 ; ny=16 ; nz=16 ; rank_to_fail=0
	   ;;
	8192)    nx=16 ; ny=16 ; nz=32 ; rank_to_fail=0
	   ;;
	16384)   nx=16 ; ny=32 ; nz=32 ; rank_to_fail=0
	   ;;
	32768)   nx=32 ; ny=32 ; nz=32 ; rank_to_fail=0
	   ;;
	65536)   nx=32 ; ny=32 ; nz=64 ; rank_to_fail=0
	   ;;
esac
